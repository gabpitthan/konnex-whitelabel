...
// Sem valor embutido: "MULTI100" vinha do fork de origem e é público.
// Validado no boot por `config/requiredSecrets.ts`.
export const REDIS_SECRET_KEY = process.env.REDIS_SECRET_KEY as string;
