...
|---|---|---|---|
| ENG-001 | Alto | parcial | Há 41 suítes/170 testes no gate versionado e integrações Redis 7; a cobertura integral do CRM continua pendente. |
...
| JOB-001 | Alto | parcial | Retenção/DLQ, stalled/failure telemetry, propagação de erro e shutdown chegaram na 1.26; falta idempotência transacional/outbox por efeito externo. |
