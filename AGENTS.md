...
5. Nunca incluir `.env`, credenciais, tokens, banco de produção, certificados privados, logs, uploads de clientes ou `node_modules`.
6. Registrar o snapshot em `PROJECT_STATE.md` e `CHANGELOG.md`.
